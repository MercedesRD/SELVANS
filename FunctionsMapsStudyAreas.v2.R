...
### Date: 21/03/2024
### modified for TERRA package and without LEAFLET (basemaps no longer free)
### Objectives:
### 1. Table with centroids for that study area (subset)
...
### Assuming the CRS in m, nt in lat long
